...
from rest_api.serializers import (
    ProductModelSerializer, CategoryModelSerializer, OrderModelSerializer)
...
class CategoryListOnlyAPIView(mixins.ListModelMixin, generics.GenericAPIView):
    ...
    # sobreecrevendo função get() que vem do generics
    def get(self, request, *args, **kwargs):
        # poderia fazer uma validação antes de retornar
